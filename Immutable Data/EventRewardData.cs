...
namespace NamPhuThuy
{
    ...
    public class EventRewardData : MonoBehaviour
    {
    ...
    /*#if UNITY_EDITOR
    [CustomEditor(typeof(EventRewardData))]
    [CanEditMultipleObjects]
    public class EventRewardDataEditor : Editor
    {
        private EventRewardData script;
